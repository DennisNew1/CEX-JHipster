...
import static de.cinema_booking.booking_system.domain.CustomerAsserts.*;
...
import de.cinema_booking.booking_system.domain.Customer;
import de.cinema_booking.booking_system.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.customerID(UPDATED_CUSTOMER_ID).name(UPDATED_NAME).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.customerID(UPDATED_CUSTOMER_ID).name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.customerID(UPDATED_CUSTOMER_ID).name(UPDATED_NAME).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
