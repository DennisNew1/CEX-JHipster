...
public class BookingAsserts {
    ...
    public static void assertBookingUpdatableFieldsEquals(Booking expected, Booking actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getBookingID()).as("check bookingID").isEqualTo(actual.getBookingID()))
            .satisfies(
                e ->
                    assertThat(e.getMovieTime())
                        .as("check movieTime")
                        .usingComparator(zonedDataTimeSameInstant)
                        .isEqualTo(actual.getMovieTime())
            )
            .satisfies(e -> assertThat(e.getSeatID()).as("check seatID").isEqualTo(actual.getSeatID()))
