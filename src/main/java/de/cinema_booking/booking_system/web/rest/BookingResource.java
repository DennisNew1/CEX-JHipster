...
/**
 * REST controller for managing {@link de.cinema_booking.booking_system.domain.Booking}.
 */
@RestController
    ...
    public ResponseEntity<Booking> partialUpdateBooking(
        ...
        Optional<Booking> result = bookingRepository
            ...
            .map(existingBooking -> {
                ...
                if (booking.getMovieTime() != null) {
                    existingBooking.setMovieTime(booking.getMovieTime());
                }
