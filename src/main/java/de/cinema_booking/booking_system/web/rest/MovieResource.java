...
/**
 * REST controller for managing {@link de.cinema_booking.booking_system.domain.Movie}.
 */
@RestController
...
public class MovieResource {
    ...
    public ResponseEntity<Movie> createMovie(@RequestBody Movie movie) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/movies/" + movie.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, movie.getId().toString()))
            .body(movie);
    }
